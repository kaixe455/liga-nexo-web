    ...
    const roundsMatches = await page.$$eval('div.robin-round > ul', rounds => {
      return Array.from(rounds, round => {
        ...
        return Array.from(matches, match => {
          ...
          MATCH.score1 = Number(match.querySelectorAll('div.versus > span.score')[0].innerText.trim())
          MATCH.score2 = Number(match.querySelectorAll('div.versus > span.score')[1].innerText.trim())
